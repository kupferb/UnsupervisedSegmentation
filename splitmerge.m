function g = splitmerge(f, mindim, fun, th)
...
S = qtdecomp(f, @split_test, mindim, fun, th);
%figure; spy(S);
...
%-------------------------------------------------------------------%
function v = split_test(B, mindim, fun, th)
